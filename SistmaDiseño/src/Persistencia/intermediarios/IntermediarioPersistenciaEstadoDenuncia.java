...
public class IntermediarioPersistenciaEstadoDenuncia extends IntermediarioRelacional{
    ...
    public String armarInsert(ObjetoPersistente obj) {
        ...
        insert = "INSERT INTO estadodenuncia (OIDEstadoDenuncia, CodigoEstadoDenuncia, NombreEstado) "
                + "VALUES ('"+estadoDenuncia.getOid()+"', "+String.valueOf(estadoDenuncia.getcodigoestadodenuncia())+", '"+estadoDenuncia.getnombreestado()+"')";
    ...
    public String armarUpdate(ObjetoPersistente obj) {
        ...
        update = "UPDATE estadodenuncia "
                + "SET OIDEstadoDenuncia = '"+estadoDenuncia.getOid()+"', "
                + "CodigoEstadoDenuncia = "+String.valueOf(estadoDenuncia.getcodigoestadodenuncia())+", "
                + "NombreEstado = '"+estadoDenuncia.getnombreestado()+"'";
